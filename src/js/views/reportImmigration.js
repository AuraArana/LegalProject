	...
	return (
		<div className="container">
			<div>
				...
				<form className="user">
					<div className="row mb-4 mt-4 card shadow border-left-primary col-lg-12 mx-auto pt-5 pb-5">
						<div className="form-group row">
							...
							<div className="col-sm-4">
								...
								<select
									className="form-control"
									onChange={e =>
										setImmigrationData({ ...immigrationData, portEntry: e.target.value })
									}>
									<option selected />
							...
							<div className="col-sm-4">
								...
								<select
									className="form-control"
									onChange={e =>
										setImmigrationData({ ...immigrationData, nationality: e.target.value })
									}>
									<option selected />
